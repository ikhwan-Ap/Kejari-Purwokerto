						...
						<div class="blog_section">
							...
							<div class="section_content">
								<ul class="nav nav-tabs">
									<li class="nav-item">
										<button class="nav-link active" aria-current="page">Jadwal Sidang</button>
									</li>
									<li class="nav-item">
										<button class="nav-link" href="#">Info Perkara Umum</button>
									</li>
									<li class="nav-item">
										<button class="nav-link" href="#">Info Perkara Khusus</button>
									</li>
									<li class="nav-item">
										<button class="nav-link" href="#">Info Perkara Datun</button>
									</li>
								</ul>
